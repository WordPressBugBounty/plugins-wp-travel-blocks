...
/* harmony import */ var progressbar_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! progressbar.js */ "./node_modules/progressbar.js/dist/progressbar.js");
...
function Edit(props) {
  ...
  const progressBarContainer = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const progressBarRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (progressBarContainer.current) {
      // Initialize the ProgressBar instance

      if (progressBarType == 'circle') {
        progressBarRef.current = new (progressbar_js__WEBPACK_IMPORTED_MODULE_4___default().Circle)(progressBarContainer.current, {
          strokeWidth: 5,
          easing: 'easeInOut',
          duration: 1400,
        ...
        progressBarRef.current = new (progressbar_js__WEBPACK_IMPORTED_MODULE_4___default().Line)(progressBarContainer.current, {
          strokeWidth: 3,
          easing: 'easeInOut',
          duration: 1400,
          color: progressBarColor || '#FFEA82',
  ...
  }, [progressBarColor, progressBarPathColor, progressNum, progressBarWidth, progressBarType]); // Add dependencies here
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Counter', 'wp-travel-blocks')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Progress Bar Type', 'wp-travel-blocks'),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Progress Number', 'wp-travel-blocks'),
    onChange: value => setAttributes({
      progressNum: value
    }),
    shiftStep: 1,
    ...
    colorSettings: [{
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Bar Color', 'wp-travel-blocks')
    }, {
      value: progressBarPathColor,
      onChange: colorValue => setAttributes({
        progressBarPathColor: colorValue
      }),
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Path Color', 'wp-travel-blocks')
    }],
    initialOpen: false
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/progress-bar/style.scss");
...
/******/ 		var installedChunks = {
/******/ 			"progress-bar/index": 0,
/******/ 			"progress-bar/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["progress-bar/style-index"], () => (__webpack_require__("./src/progress-bar/index.js")))
