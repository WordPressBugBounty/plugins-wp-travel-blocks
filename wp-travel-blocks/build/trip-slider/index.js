...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/trip-slider/editor.scss");
...
/* harmony import */ var _assets_slick_slick_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../../assets/slick/slick.css */ "./assets/slick/slick.css");
/* harmony import */ var _assets_slick_slick_theme_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../../assets/slick/slick-theme.css */ "./assets/slick/slick-theme.css");
...
function Edit(props) {
  ...
  const sliderPram = {
    ...
    featuredTrip: props.attributes.featuredTrip,
    saleTrip: props.attributes.saleTrip,
    sliderArrow: props.attributes.sliderArrow,
    sliderAutoplay: props.attributes.sliderAutoplay,
    sliderDots: props.attributes.sliderDots,
    sliderHeight: props.attributes.sliderHeight
  };
  ...
  const [tripLists, setTripLists] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(() => {
    fetch(_wp_travel.site_url + '/wp-json/wptravel/v1/get-slider-trips?param=' + JSON.stringify(sliderPram), {
      method: "GET"
    }).then(res => res.json()).then(data => {
      setTripLists(data);
    }).catch(err => console.error(err));
  }, []);
  const onChangeItemNumber = newNumberOfItems => {
    sliderPram.query = {
      ...query,
  ...
  const onChangeOrder = (newOrderBy, newOrder) => {
    sliderPram.query = {
      ...query,
      orderBy: newOrderBy,
      order: newOrder
  ...
  const onChangeTripTypes = tokens => {
  ...
  const onChangeTripDestinations = tokens => {
    const allCategories = tokens.map(token => {
  ...
  const onChangeTripActivity = tokens => {
    const allCategories = tokens.map(token => {
  ...
  const onChangeTripKeywords = tokens => {
    const allCategories = tokens.map(token => {
  ...
  const onChangeSaleTrip = () => {
    sliderPram.saleTrip = !saleTrip;
    fetch(_wp_travel.site_url + '/wp-json/wptravel/v1/get-slider-trips?param=' + JSON.stringify(sliderPram), {
      method: "GET"
    }).then(res => res.json()).then(data => {
      if (data !== tripLists) {
  ...
  const onChangeFeaturedTrip = () => {
    sliderPram.featuredTrip = !featuredTrip;
    fetch(_wp_travel.site_url + '/wp-json/wptravel/v1/get-slider-trips?param=' + JSON.stringify(sliderPram), {
      method: "GET"
    }).then(res => res.json()).then(data => {
      if (data !== tripLists) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: selectedVal => {
      ...
      onChangeOrder(newOrderBy, newOrder);
    }
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Trip Type', 'wp-travel-blocks'),
    ...
    onChange: tokens => {
      onChangeTripTypes(tokens);
    }
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.FormTokenField, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Trip Destinations', 'wp-travel-blocks'),
    ...
    onChange: tokens => {
      onChangeTripDestinations(tokens);
    }
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.FormTokenField, {
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, "No Trips Found! Make sure you have trips set up for selected filter.")))));
}

/***/ }),

/***/ "./src/trip-slider/index.js":
/*!**********************************!*\
  !*** ./src/trip-slider/index.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/trip-slider/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/trip-slider/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/trip-slider/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/trip-slider/block.json");
/**
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["trip-slider/style-index"], () => (__webpack_require__("./src/trip-slider/index.js")))
