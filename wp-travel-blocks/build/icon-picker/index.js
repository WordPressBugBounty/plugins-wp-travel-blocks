...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/icon-picker/editor.scss");
/* harmony import */ var _font_awesome_css_fontawesome_all_min_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./font-awesome/css/fontawesome-all.min.css */ "./src/icon-picker/font-awesome/css/fontawesome-all.min.css");
...
function Edit(props) {
  ...
  const icons = {
    ...
    'Animal': ['fas fa-spider', 'fas fa-paw', 'fas fa-otter', 'fas fa-kiwi-bird', 'fas fa-horse', 'fas fa-hippo', 'fas fa-frog', 'fas fa-fish', 'fas fa-feather-alt', 'fas fa-feather', 'fas fa-dragon', 'fas fa-dove', 'fas fa-dog', 'fas fa-crow', 'fas fa-cat'],
    'Arrows': ['fas fa-upload', 'fas fa-undo-alt', 'fas fa-text-width', 'fas fa-text-height', 'fas fa-sync-alt', 'fas fa-sync', 'fas fa-sort-up', 'fas fa-sort-numeric-up', 'fas fa-sort-numeric-down', 'fas fa-sort-down', 'fas fa-sort-amount-up', 'fas fa-sort-amount-down', 'fas fa-sort-alpha-up', 'fas fa-sort-alpha-down', 'fas fa-sort', 'fas fa-sign-out-alt', 'fas fa-sign-in-alt', 'fas fa-share-square', 'fas fa-share', 'fas fa-retweet', 'fas fa-reply-all', 'fas fa-reply', 'fas fa-redo-alt', 'fas fa-redo', 'fas fa-recycle', 'fas fa-random', 'fas fa-play', 'fas fa-mouse-pointer', 'fas fa-long-arrow-alt-up', 'fas fa-long-arrow-alt-right', 'fas fa-long-arrow-alt-left', 'fas fa-long-arrow-alt-down', 'fas fa-location-arrow', 'fas fa-level-up-alt', 'fas fa-level-down-alt', 'fas fa-history', 'fas fa-hand-pointer', 'fas fa-hand-point-up', 'fas fa-hand-point-right', 'fas fa-hand-point-left', 'fas fa-hand-point-down', 'fas fa-external-link-square-alt', 'fas fa-external-link-alt', 'fas fa-expand-arrows-alt', 'fas fa-exchange-alt', 'fas fa-download', 'fas fa-cloud-upload-alt', 'fas fa-cloud-download-alt', 'fas fa-chevron-up', 'fas fa-chevron-right', 'fas fa-chevron-left', 'fas fa-chevron-down', 'fas fa-chevron-circle-up', 'fas fa-chevron-circle-right', 'fas fa-chevron-circle-left', 'fas fa-chevron-circle-down', 'fas fa-chart-line', 'fas fa-cart-arrow-down', 'fas fa-caret-up', 'fas fa-caret-square-up', 'fas fa-caret-square-right', 'fas fa-caret-square-left', 'fas fa-caret-square-down', 'fas fa-caret-right', 'fas fa-caret-left', 'fas fa-caret-down', 'fas fa-arrows-alt-v', 'fas fa-arrows-alt-h', 'fas fa-arrows-alt', 'fas fa-arrow-up', 'fas fa-arrow-right', 'fas fa-arrow-left', 'fas fa-arrow-down', 'fas fa-arrow-circle-up', 'fas fa-arrow-circle-right', 'fas fa-arrow-circle-left', 'fas fa-arrow-circle-down', 'fas fa-arrow-alt-circle-up', 'fas fa-arrow-alt-circle-right', 'fas fa-arrow-alt-circle-left', 'fas fa-arrow-alt-circle-down', 'fas fa-angle-up', 'fas fa-angle-right', 'fas fa-angle-left', 'fas fa-angle-down', 'fas fa-angle-double-up', 'fas fa-angle-double-right', 'fas fa-angle-double-left', 'fas fa-angle-double-down', 'far fa-share-square', 'far fa-hand-pointer', 'far fa-hand-point-up', 'far fa-hand-point-right', 'far fa-hand-point-left', 'far fa-hand-point-down', 'far fa-caret-square-up', 'far fa-caret-square-right', 'far fa-caret-square-left', 'far fa-caret-square-down', 'far fa-arrow-alt-circle-up', 'far fa-arrow-alt-circle-right', 'far fa-arrow-alt-circle-left', 'far fa-arrow-alt-circle-down'],
    'Audio & Video': ['fas fa-volume-up', 'fas fa-volume-off', 'fas fa-volume-mute', 'fas fa-volume-down', 'fas fa-video', 'fas fa-undo-alt', 'fas fa-undo', 'fas fa-tv', 'fas fa-sync-alt', 'fas fa-sync', 'fas fa-stop-circle', 'fas fa-stop', 'fas fa-step-forward', 'fas fa-step-backward', 'fas fa-rss-square', 'fas fa-rss', 'fas fa-redo-alt', 'fas fa-redo', 'fas fa-random', 'fas fa-podcast', 'fas fa-play-circle', 'fas fa-play', 'fas fa-phone-volume', 'fas fa-pause-circle', 'fas fa-pause', 'fas fa-music', 'fas fa-microphone-slash', 'fas fa-microphone-alt-slash', 'fas fa-microphone-alt', 'fas fa-microphone', 'fas fa-headphones', 'fas fa-forward', 'fas fa-film', 'fas fa-file-video', 'fas fa-file-audio', 'fas fa-fast-forward', 'fas fa-fast-backward', 'fas fa-expand-arrows-alt', 'fas fa-expand', 'fas fa-eject', 'fas fa-compress', 'fas fa-closed-captioning', 'fas fa-circle', 'fas fa-broadcast-tower', 'fas fa-backward', 'fas fa-audio-description', 'fab fa-youtube', 'far fa-stop-circle', 'far fa-play-circle', 'far fa-pause-circle', 'far fa-file-video', 'far fa-file-audio', 'far fa-closed-captioning', 'far fa-circle'],
    'Automotive': ['fas fa-truck-pickup', 'fas fa-truck-monster', 'fas fa-truck', 'fas fa-taxi', 'fas fa-tachometer-alt', 'fas fa-shuttle-van', 'fas fa-oil-can', 'fas fa-motorcycle', 'fas fa-gas-pump', 'fas fa-charging-station', 'fas fa-car-side', 'fas fa-car-crash', 'fas fa-car-battery', 'fas fa-car-alt', 'fas fa-car', 'fas fa-bus-alt', 'fas fa-bus', 'fas fa-ambulance', 'fas fa-air-freshener'],
    'Autumn': ['fas fa-wine-bottle', 'fas fa-wind', 'fas fa-tree', 'fas fa-tractor', 'fas fa-mountain', 'fas fa-hiking', 'fas fa-football-ball', 'fas fa-drumstick-bite', 'fas fa-cloud-sun', 'fas fa-campground', 'fas fa-apple-alt'],
    'Beverage': ['fas fa-wine-glass-alt', 'fas fa-wine-glass', 'fas fa-wine-bottle', 'fas fa-glass-martini-alt', 'fas fa-glass-martini', 'fas fa-flask', 'fas fa-coffee', 'fas fa-cocktail', 'fas fa-blender', 'fas fa-beer'],
    'Buildings': ['fas fa-warehouse', 'fas fa-vihara', 'fas fa-university', 'fas fa-torii-gate', 'fas fa-synagogue', 'fas fa-store-alt', 'fas fa-store', 'fas fa-school', 'fas fa-place-of-worship', 'fas fa-mosque', 'fas fa-monument', 'fas fa-landmark', 'fas fa-kaaba', 'fas fa-industry', 'fas fa-house-damage', 'fas fa-hotel', 'fas fa-hospital-alt', 'fas fa-hospital', 'fas fa-home', 'fas fa-gopuram', 'fas fa-dungeon', 'fas fa-city', 'fas fa-church', 'fas fa-campground', 'fas fa-building', 'fas fa-archway', 'far fa-hospital', 'far fa-building'],
    'Business': ['fas fa-wallet', 'fas fa-trademark', 'fas fa-thumbtack', 'fas fa-tasks', 'fas fa-tags', 'fas fa-tag', 'fas fa-table', 'fas fa-stream', 'fas fa-sticky-note', 'fas fa-socks', 'fas fa-sitemap', 'fas fa-save', 'fas fa-registered', 'fas fa-project-diagram', 'fas fa-print', 'fas fa-phone-volume', 'fas fa-phone-square', 'fas fa-phone-slash', 'fas fa-phone', 'fas fa-percent', 'fas fa-pencil-alt', 'fas fa-pen-square', 'fas fa-pen-nib', 'fas fa-pen-fancy', 'fas fa-pen-alt', 'fas fa-pen', 'fas fa-paste', 'fas fa-paperclip', 'fas fa-marker', 'fas fa-landmark', 'fas fa-industry', 'fas fa-highlighter', 'fas fa-globe', 'fas fa-glasses', 'fas fa-folder-plus', 'fas fa-folder-open', 'fas fa-folder-minus', 'fas fa-folder', 'fas fa-file-alt', 'fas fa-file', 'fas fa-fax', 'fas fa-eraser', 'fas fa-envelope-square', 'fas fa-envelope-open', 'fas fa-envelope', 'fas fa-edit', 'fas fa-cut', 'fas fa-copyright', 'fas fa-copy', 'fas fa-compass', 'fas fa-columns', 'fas fa-coffee', 'fas fa-clipboard', 'fas fa-city', 'fas fa-chart-pie', 'fas fa-chart-line', 'fas fa-chart-bar', 'fas fa-chart-area', 'fas fa-certificate', 'fas fa-calendar-alt', 'fas fa-calendar', 'fas fa-calculator', 'fas fa-business-time', 'fas fa-bullseye', 'fas fa-bullhorn', 'fas fa-building', 'fas fa-briefcase', 'fas fa-book', 'fas fa-birthday-cake', 'fas fa-balance-scale', 'fas fa-archive', 'fas fa-address-card', 'fas fa-address-book', 'far fa-sticky-note', 'far fa-save', 'far fa-registered', 'far fa-folder-open', 'far fa-folder', 'far fa-file-alt', 'far fa-file', 'far fa-envelope-open', 'far fa-envelope', 'far fa-edit', 'far fa-copyright', 'far fa-copy', 'far fa-compass', 'far fa-clipboard', 'far fa-chart-bar', 'far fa-calendar-alt', 'far fa-calendar', 'far fa-building', 'far fa-address-card', 'far fa-address-book'],
    'Camping': ['fas fa-tree', 'fas fa-toilet-paper', 'fas fa-route', 'fas fa-mountain', 'fas fa-map-signs', 'fas fa-map-marked-alt', 'fas fa-map-marked', 'fas fa-map', 'fas fa-hiking', 'fas fa-frog', 'fas fa-first-aid', 'fas fa-fire', 'fas fa-compass', 'fas fa-campground', 'fas fa-binoculars', 'far fa-map', 'far fa-compass'],
    'Charity': ['fas fa-seedling', 'fas fa-ribbon', 'fas fa-piggy-bank', 'fas fa-parachute-box', 'fas fa-leaf', 'fas fa-heart', 'fas fa-handshake', 'fas fa-hands-helping', 'fas fa-hand-holding-usd', 'fas fa-hand-holding-heart', 'fas fa-globe', 'fas fa-gift', 'fas fa-dove', 'fas fa-donate', 'fas fa-dollar-sign', 'far fa-heart', 'far fa-handshake'],
    'Chat': ['fas fa-video-slash', 'fas fa-video', 'fas fa-smile', 'fas fa-quote-right', 'fas fa-quote-left', 'fas fa-poo', 'fas fa-phone-slash', 'fas fa-phone', 'fas fa-meh', 'fas fa-frown', 'fas fa-comments', 'fas fa-comment-slash', 'fas fa-comment-dots', 'fas fa-comment-alt', 'fas fa-comment', 'far fa-smile', 'far fa-meh', 'far fa-frown', 'far fa-comments', 'far fa-comment-dots', 'far fa-comment-alt', 'far fa-comment'],
    'Chess': ['fas fa-square-full', 'fas fa-chess-rook', 'fas fa-chess-queen', 'fas fa-chess-pawn', 'fas fa-chess-knight', 'fas fa-chess-king', 'fas fa-chess-board', 'fas fa-chess-bishop', 'fas fa-chess'],
    'Childhood': ['fas fa-shapes', 'fas fa-school', 'fas fa-robot', 'fas fa-gamepad', 'fas fa-cookie-bite', 'fas fa-cookie', 'fas fa-birthday-cake', 'fas fa-bath', 'fas fa-apple-alt'],
    'Clothing': ['fas fa-user-tie', 'fas fa-tshirt', 'fas fa-socks', 'fas fa-shoe-prints', 'fas fa-hat-wizard', 'fas fa-graduation-cap'],
    'Code': ['fas fa-window-restore', 'fas fa-window-minimize', 'fas fa-window-maximize', 'fas fa-window-close', 'fas fa-user-secret', 'fas fa-terminal', 'fas fa-stream', 'fas fa-sitemap', 'fas fa-shield-alt', 'fas fa-qrcode', 'fas fa-project-diagram', 'fas fa-microchip', 'fas fa-laptop-code', 'fas fa-keyboard', 'fas fa-folder-open', 'fas fa-folder', 'fas fa-fire-extinguisher', 'fas fa-filter', 'fas fa-file-code', 'fas fa-file-alt', 'fas fa-file', 'fas fa-coffee', 'fas fa-code-branch', 'fas fa-code', 'fas fa-bug', 'fas fa-bath', 'fas fa-barcode', 'fas fa-archive', 'far fa-window-restore', 'far fa-window-minimize', 'far fa-window-maximize', 'far fa-window-close', 'far fa-keyboard', 'far fa-folder-open', 'far fa-folder', 'far fa-file-code', 'far fa-file-alt', 'far fa-file'],
    'Communication': ['fas fa-wifi', 'fas fa-tty', 'fas fa-rss-square', 'fas fa-rss', 'fas fa-phone-volume', 'fas fa-phone-square', 'fas fa-phone-slash', 'fas fa-phone', 'fas fa-paper-plane', 'fas fa-mobile-alt', 'fas fa-mobile', 'fas fa-microphone-slash', 'fas fa-microphone-alt-slash', 'fas fa-microphone-alt', 'fas fa-microphone', 'fas fa-language', 'fas fa-inbox', 'fas fa-fax', 'fas fa-envelope-square', 'fas fa-envelope-open', 'fas fa-envelope', 'fas fa-comments', 'fas fa-comment-alt', 'fas fa-comment', 'fas fa-chalkboard', 'fas fa-bullhorn', 'fas fa-broadcast-tower', 'fas fa-bell-slash', 'fas fa-bell', 'fas fa-at', 'fas fa-assistive-listening-systems', 'fas fa-american-sign-language-interpreting', 'fas fa-address-card', 'fas fa-address-book', 'fab fa-bluetooth-b', 'fab fa-bluetooth', 'far fa-paper-plane', 'far fa-envelope-open', 'far fa-envelope', 'far fa-comments', 'far fa-comment-alt', 'far fa-comment', 'far fa-bell-slash', 'far fa-bell', 'far fa-address-card', 'far fa-address-book'],
    'Computers': ['fas fa-upload', 'fas fa-tv', 'fas fa-tablet-alt', 'fas fa-tablet', 'fas fa-stream', 'fas fa-save', 'fas fa-print', 'fas fa-power-off', 'fas fa-plug', 'fas fa-mobile-alt', 'fas fa-mobile', 'fas fa-microchip', 'fas fa-memory', 'fas fa-laptop', 'fas fa-keyboard', 'fas fa-headphones', 'fas fa-hdd', 'fas fa-download', 'fas fa-desktop', 'fas fa-database', 'fas fa-compact-disc', 'far fa-save', 'far fa-keyboard', 'far fa-hdd'],
    'Construction': ['fas fa-wrench', 'fas fa-truck-pickup', 'fas fa-toolbox', 'fas fa-screwdriver', 'fas fa-ruler-vertical', 'fas fa-ruler-horizontal', 'fas fa-ruler-combined', 'fas fa-ruler', 'fas fa-pencil-ruler', 'fas fa-pencil-alt', 'fas fa-paint-roller', 'fas fa-hammer', 'fas fa-drafting-compass', 'fas fa-brush'],
    'Currency': ['fas fa-yen-sign', 'fas fa-won-sign', 'fas fa-shekel-sign', 'fas fa-rupee-sign', 'fas fa-ruble-sign', 'fas fa-pound-sign', 'fas fa-money-check-alt', 'fas fa-money-check', 'fas fa-money-bill-wave-alt', 'fas fa-money-bill-wave', 'fas fa-money-bill-alt', 'fas fa-money-bill', 'fas fa-lira-sign', 'fas fa-hryvnia', 'fas fa-euro-sign', 'fas fa-dollar-sign', 'fab fa-gg-circle', 'fab fa-gg', 'fab fa-ethereum', 'fab fa-btc', 'fab fa-bitcoin', 'far fa-money-bill-alt'],
    'Date & Time': ['fas fa-stopwatch', 'fas fa-hourglass-start', 'fas fa-hourglass-half', 'fas fa-hourglass-end', 'fas fa-hourglass', 'fas fa-clock', 'fas fa-calendar-times', 'fas fa-calendar-plus', 'fas fa-calendar-minus', 'fas fa-calendar-check', 'fas fa-calendar-alt', 'fas fa-calendar', 'fas fa-bell-slash', 'fas fa-bell', 'far fa-hourglass', 'far fa-clock', 'far fa-calendar-times', 'far fa-calendar-plus', 'far fa-calendar-minus', 'far fa-calendar-check', 'far fa-calendar-alt', 'far fa-calendar', 'far fa-bell-slash', 'far fa-bell'],
    'Design': ['fas fa-vector-square', 'fas fa-tint-slash', 'fas fa-tint', 'fas fa-swatchbook', 'fas fa-stamp', 'fas fa-spray-can', 'fas fa-splotch', 'fas fa-save', 'fas fa-ruler-vertical', 'fas fa-ruler-horizontal', 'fas fa-ruler-combined', 'fas fa-pencil-ruler', 'fas fa-pencil-alt', 'fas fa-pen-nib', 'fas fa-pen-fancy', 'fas fa-pen-alt', 'fas fa-pen', 'fas fa-paste', 'fas fa-palette', 'fas fa-paint-roller', 'fas fa-paint-brush', 'fas fa-object-ungroup', 'fas fa-object-group', 'fas fa-marker', 'fas fa-magic', 'fas fa-layer-group', 'fas fa-highlighter', 'fas fa-fill-drip', 'fas fa-fill', 'fas fa-eye-slash', 'fas fa-eye-dropper', 'fas fa-eye', 'fas fa-eraser', 'fas fa-edit', 'fas fa-draw-polygon', 'fas fa-drafting-compass', 'fas fa-cut', 'fas fa-crosshairs', 'fas fa-crop-alt', 'fas fa-crop', 'fas fa-copy', 'fas fa-clone', 'fas fa-brush', 'fas fa-bezier-curve', 'fas fa-adjust', 'far fa-save', 'far fa-object-ungroup', 'far fa-object-group', 'far fa-eye-slash', 'far fa-eye', 'far fa-edit', 'far fa-copy', 'far fa-clone'],
    'Editors': ['fas fa-wrench', 'fas fa-unlink', 'fas fa-undo-alt', 'fas fa-undo', 'fas fa-underline', 'fas fa-trash-alt', 'fas fa-trash', 'fas fa-th-list', 'fas fa-th-large', 'fas fa-th', 'fas fa-text-width', 'fas fa-text-height', 'fas fa-tasks', 'fas fa-table', 'fas fa-sync-alt', 'fas fa-sync', 'fas fa-superscript', 'fas fa-subscript', 'fas fa-strikethrough', 'fas fa-share', 'fas fa-screwdriver', 'fas fa-reply-all', 'fas fa-reply', 'fas fa-redo-alt', 'fas fa-redo', 'fas fa-quote-right', 'fas fa-quote-left', 'fas fa-print', 'fas fa-pencil-alt', 'fas fa-pen-nib', 'fas fa-pen-fancy', 'fas fa-pen-alt', 'fas fa-pen', 'fas fa-paste', 'fas fa-paragraph', 'fas fa-paperclip', 'fas fa-paper-plane', 'fas fa-outdent', 'fas fa-marker', 'fas fa-list-ul', 'fas fa-list-ol', 'fas fa-list-alt', 'fas fa-list', 'fas fa-link', 'fas fa-italic', 'fas fa-indent', 'fas fa-i-cursor', 'fas fa-highlighter', 'fas fa-heading', 'fas fa-glasses', 'fas fa-font', 'fas fa-file-alt', 'fas fa-file', 'fas fa-eraser', 'fas fa-edit', 'fas fa-cut', 'fas fa-copy', 'fas fa-columns', 'fas fa-clone', 'fas fa-clipboard', 'fas fa-bold', 'fas fa-align-right', 'fas fa-align-left', 'fas fa-align-justify', 'fas fa-align-center', 'far fa-trash-alt', 'far fa-list-alt', 'far fa-file-alt', 'far fa-file', 'far fa-edit', 'far fa-copy', 'far fa-clone', 'far fa-clipboard'],
    'Education': ['fas fa-user-graduate', 'fas fa-theater-masks', 'fas fa-shapes', 'fas fa-school', 'fas fa-music', 'fas fa-microscope', 'fas fa-laptop-code', 'fas fa-graduation-cap', 'fas fa-chalkboard-teacher', 'fas fa-chalkboard', 'fas fa-book-reader', 'fas fa-book-open', 'fas fa-bell-slash', 'fas fa-bell', 'fas fa-award', 'fas fa-atom', 'fas fa-apple-alt', 'far fa-bell-slash', 'far fa-bell'],
    'Emoji': ['fas fa-tired', 'fas fa-surprise', 'fas fa-smile-wink', 'fas fa-smile-beam', 'fas fa-smile', 'fas fa-sad-tear', 'fas fa-sad-cry', 'fas fa-meh-rolling-eyes', 'fas fa-meh-blank', 'fas fa-meh', 'fas fa-laugh-wink', 'fas fa-laugh-squint', 'fas fa-laugh-beam', 'fas fa-laugh', 'fas fa-kiss-wink-heart', 'fas fa-kiss-beam', 'fas fa-kiss', 'fas fa-grin-wink', 'fas fa-grin-tongue-wink', 'fas fa-grin-tongue-squint', 'fas fa-grin-tongue', 'fas fa-grin-tears', 'fas fa-grin-stars', 'fas fa-grin-squint-tears', 'fas fa-grin-squint', 'fas fa-grin-hearts', 'fas fa-grin-beam-sweat', 'fas fa-grin-beam', 'fas fa-grin-alt', 'fas fa-grin', 'fas fa-grimace', 'fas fa-frown-open', 'fas fa-frown', 'fas fa-flushed', 'fas fa-dizzy', 'fas fa-angry', 'far fa-tired', 'far fa-surprise', 'far fa-smile-wink', 'far fa-smile-beam', 'far fa-smile', 'far fa-sad-tear', 'far fa-sad-cry', 'far fa-meh-rolling-eyes', 'far fa-meh-blank', 'far fa-meh', 'far fa-laugh-wink', 'far fa-laugh-squint', 'far fa-laugh-beam', 'far fa-laugh', 'far fa-kiss-wink-heart', 'far fa-kiss-beam', 'far fa-kiss', 'far fa-grin-wink', 'far fa-grin-tongue-wink', 'far fa-grin-tongue-squint', 'far fa-grin-tongue', 'far fa-grin-tears', 'far fa-grin-stars', 'far fa-grin-squint-tears', 'far fa-grin-squint', 'far fa-grin-hearts', 'far fa-grin-beam-sweat', 'far fa-grin-beam', 'far fa-grin-alt', 'far fa-grin', 'far fa-grimace', 'far fa-frown-open', 'far fa-frown', 'far fa-flushed', 'far fa-dizzy', 'far fa-angry'],
    'Energy': ['fas fa-wind', 'fas fa-sun', 'fas fa-solar-panel', 'fas fa-seedling', 'fas fa-power-off', 'fas fa-poop', 'fas fa-plug', 'fas fa-lightbulb', 'fas fa-leaf', 'fas fa-industry', 'fas fa-gas-pump', 'fas fa-fire', 'fas fa-charging-station', 'fas fa-burn', 'fas fa-broadcast-tower', 'fas fa-battery-three-quarters', 'fas fa-battery-quarter', 'fas fa-battery-half', 'fas fa-battery-full', 'fas fa-battery-empty', 'fas fa-atom', 'far fa-sun', 'far fa-lightbulb'],
    'Files': ['fas fa-sticky-note', 'fas fa-save', 'fas fa-paste', 'fas fa-folder-open', 'fas fa-folder', 'fas fa-file-word', 'fas fa-file-video', 'fas fa-file-powerpoint', 'fas fa-file-pdf', 'fas fa-file-image', 'fas fa-file-excel', 'fas fa-file-code', 'fas fa-file-audio', 'fas fa-file-archive', 'fas fa-file-alt', 'fas fa-file', 'fas fa-cut', 'fas fa-copy', 'fas fa-clone', 'fas fa-archive', 'far fa-sticky-note', 'far fa-save', 'far fa-folder-open', 'far fa-folder', 'far fa-file-word', 'far fa-file-video', 'far fa-file-powerpoint', 'far fa-file-pdf', 'far fa-file-image', 'far fa-file-excel', 'far fa-file-code', 'far fa-file-audio', 'far fa-file-archive', 'far fa-file-alt', 'far fa-file', 'far fa-copy', 'far fa-clone'],
    'Finance': ['fas fa-wallet', 'fas fa-stamp', 'fas fa-receipt', 'fas fa-piggy-bank', 'fas fa-percentage', 'fas fa-money-check-alt', 'fas fa-money-check', 'fas fa-money-bill-wave-alt', 'fas fa-money-bill-wave', 'fas fa-money-bill-alt', 'fas fa-money-bill', 'fas fa-landmark', 'fas fa-hand-holding-usd', 'fas fa-file-invoice-dollar', 'fas fa-file-invoice', 'fas fa-donate', 'fas fa-credit-card', 'fas fa-comments-dollar', 'fas fa-comment-dollar', 'fas fa-coins', 'fas fa-chart-pie', 'fas fa-chart-line', 'fas fa-book', 'fas fa-balance-scale', 'far fa-money-bill-alt', 'far fa-credit-card'],
    'Fitness': ['fas fa-walking', 'fas fa-swimmer', 'fas fa-spa', 'fas fa-shoe-prints', 'fas fa-running', 'fas fa-hiking', 'fas fa-heartbeat', 'fas fa-heart', 'fas fa-burn', 'fas fa-bicycle', 'far fa-heart'],
    'Food': ['fas fa-stroopwafel', 'fas fa-seedling', 'fas fa-pepper-hot', 'fas fa-lemon', 'fas fa-fish', 'fas fa-drumstick-bite', 'fas fa-cookie', 'fas fa-bone', 'fas fa-apple-alt', 'far fa-lemon'],
    'Fruits & Vegetables': ['fas fa-seedling', 'fas fa-lemon', 'fas fa-leaf', 'fas fa-apple-alt', 'far fa-lemon'],
    'Games': ['fas fa-puzzle-piece', 'fas fa-heart', 'fas fa-headset', 'fas fa-ghost', 'fas fa-gamepad', 'fas fa-dice-two', 'fas fa-dice-three', 'fas fa-dice-six', 'fas fa-dice-one', 'fas fa-dice-four', 'fas fa-dice-five', 'fas fa-dice-d6', 'fas fa-dice-d20', 'fas fa-dice', 'fas fa-chess-rook', 'fas fa-chess-queen', 'fas fa-chess-pawn', 'fas fa-chess-knight', 'fas fa-chess-king', 'fas fa-chess-board', 'fas fa-chess-bishop', 'fas fa-chess', 'fab fa-xbox', 'fab fa-twitch', 'fab fa-steam-symbol', 'fab fa-steam-square', 'fab fa-steam', 'fab fa-playstation', 'far fa-heart'],
    'Tabletop Gaming': ['fas fa-skull-crossbones', 'fas fa-scroll', 'fas fa-ring', 'fas fa-hat-wizard', 'fas fa-fist-raised', 'fas fa-dungeon', 'fas fa-dragon', 'fas fa-dice-d6', 'fas fa-dice-d20', 'fas fa-book-dead', 'fab fa-wizards-of-the-coast', 'fab fa-penny-arcade', 'fab fa-fantasy-flight-games', 'fab fa-d-and-d-beyond', 'fab fa-d-and-d', 'fab fa-critical-role', 'fab fa-acquisitions-incorporated'],
    'Genders': ['fas fa-venus-mars', 'fas fa-venus-double', 'fas fa-venus', 'fas fa-transgender-alt', 'fas fa-transgender', 'fas fa-neuter', 'fas fa-mercury', 'fas fa-mars-stroke-v', 'fas fa-mars-stroke-h', 'fas fa-mars-stroke', 'fas fa-mars-double', 'fas fa-mars', 'fas fa-genderless'],
    'Halloween': ['fas fa-toilet-paper', 'fas fa-spider', 'fas fa-skull-crossbones', 'fas fa-mask', 'fas fa-hat-wizard', 'fas fa-ghost', 'fas fa-crow', 'fas fa-cloud-moon', 'fas fa-cat', 'fas fa-broom', 'fas fa-book-dead'],
    'Hands': ['fas fa-thumbs-up', 'fas fa-thumbs-down', 'fas fa-praying-hands', 'fas fa-handshake', 'fas fa-hands-helping', 'fas fa-hands', 'fas fa-hand-spock', 'fas fa-hand-scissors', 'fas fa-hand-rock', 'fas fa-hand-pointer', 'fas fa-hand-point-up', 'fas fa-hand-point-right', 'fas fa-hand-point-left', 'fas fa-hand-point-down', 'fas fa-hand-peace', 'fas fa-hand-paper', 'fas fa-hand-lizard', 'fas fa-hand-holding-usd', 'fas fa-hand-holding-heart', 'fas fa-hand-holding', 'fas fa-fist-raised', 'fas fa-allergies', 'far fa-thumbs-up', 'far fa-thumbs-down', 'far fa-handshake', 'far fa-hand-spock', 'far fa-hand-scissors', 'far fa-hand-rock', 'far fa-hand-pointer', 'far fa-hand-point-up', 'far fa-hand-point-right', 'far fa-hand-point-left', 'far fa-hand-point-down', 'far fa-hand-peace', 'far fa-hand-paper', 'far fa-hand-lizard'],
    'Health': ['fas fa-wheelchair', 'fas fa-user-md', 'fas fa-stethoscope', 'fas fa-prescription', 'fas fa-plus-square', 'fas fa-medkit', 'fas fa-hospital', 'fas fa-heartbeat', 'fas fa-heart', 'fas fa-h-square', 'fas fa-ambulance', 'fab fa-accessible-icon', 'far fa-plus-square', 'far fa-hospital', 'far fa-heart'],
    'Holiday': ['fas fa-gift', 'fas fa-cookie-bite'],
    'Hotel': ['fas fa-wifi', 'fas fa-wheelchair', 'fas fa-utensils', 'fas fa-umbrella-beach', 'fas fa-tv', 'fas fa-swimming-pool', 'fas fa-swimmer', 'fas fa-suitcase-rolling', 'fas fa-suitcase', 'fas fa-spa', 'fas fa-snowflake', 'fas fa-smoking-ban', 'fas fa-smoking', 'fas fa-shuttle-van', 'fas fa-shower', 'fas fa-luggage-cart', 'fas fa-key', 'fas fa-infinity', 'fas fa-hotel', 'fas fa-hot-tub', 'fas fa-glass-martini-alt', 'fas fa-glass-martini', 'fas fa-dumbbell', 'fas fa-door-open', 'fas fa-door-closed', 'fas fa-dice-five', 'fas fa-dice', 'fas fa-concierge-bell', 'fas fa-coffee', 'fas fa-cocktail', 'fas fa-car', 'fas fa-briefcase', 'fas fa-bed', 'fas fa-bath', 'far fa-snowflake'],
    'Household': ['fas fa-tv', 'fas fa-toilet-paper', 'fas fa-snowflake', 'fas fa-shower', 'fas fa-plug', 'fas fa-lightbulb', 'fas fa-dungeon', 'fas fa-door-open', 'fas fa-door-closed', 'fas fa-couch', 'fas fa-coffee', 'fas fa-chair', 'fas fa-blender', 'fas fa-bell', 'fas fa-bed', 'fas fa-bath', 'far fa-snowflake', 'far fa-lightbulb', 'far fa-bell'],
    'Images': ['fas fa-tint', 'fas fa-sliders-h', 'fas fa-portrait', 'fas fa-images', 'fas fa-image', 'fas fa-id-card', 'fas fa-id-badge', 'fas fa-film', 'fas fa-file-image', 'fas fa-eye-slash', 'fas fa-eye-dropper', 'fas fa-eye', 'fas fa-expand', 'fas fa-compress', 'fas fa-clone', 'fas fa-chalkboard', 'fas fa-camera-retro', 'fas fa-camera', 'fas fa-bolt', 'fas fa-adjust', 'far fa-images', 'far fa-image', 'far fa-id-card', 'far fa-id-badge', 'far fa-file-image', 'far fa-eye-slash', 'far fa-eye', 'far fa-clone'],
    'Interfaces': ['fas fa-wrench', 'fas fa-wifi', 'fas fa-volume-up', 'fas fa-volume-off', 'fas fa-volume-mute', 'fas fa-volume-down', 'fas fa-user-circle', 'fas fa-user-alt', 'fas fa-user', 'fas fa-upload', 'fas fa-undo-alt', 'fas fa-undo', 'fas fa-trophy', 'fas fa-trash-alt', 'fas fa-trash', 'fas fa-toggle-on', 'fas fa-toggle-off', 'fas fa-times-circle', 'fas fa-times', 'fas fa-thumbs-up', 'fas fa-thumbs-down', 'fas fa-sync-alt', 'fas fa-sync', 'fas fa-star-half', 'fas fa-star', 'fas fa-sort-up', 'fas fa-sort-numeric-up', 'fas fa-sort-numeric-down', 'fas fa-sort-down', 'fas fa-sort-amount-up', 'fas fa-sort-amount-down', 'fas fa-sort-alpha-up', 'fas fa-sort-alpha-down', 'fas fa-sort', 'fas fa-smile', 'fas fa-sliders-h', 'fas fa-sitemap', 'fas fa-signal', 'fas fa-sign-out-alt', 'fas fa-sign-in-alt', 'fas fa-shield-alt', 'fas fa-share-square', 'fas fa-share-alt-square', 'fas fa-share-alt', 'fas fa-share', 'fas fa-search-plus', 'fas fa-search-minus', 'fas fa-search', 'fas fa-screwdriver', 'fas fa-save', 'fas fa-rss-square', 'fas fa-rss', 'fas fa-reply-all', 'fas fa-reply', 'fas fa-redo-alt', 'fas fa-redo', 'fas fa-quote-right', 'fas fa-quote-left', 'fas fa-question-circle', 'fas fa-question', 'fas fa-qrcode', 'fas fa-poo', 'fas fa-plus-square', 'fas fa-plus-circle', 'fas fa-plus', 'fas fa-pencil-alt', 'fas fa-pen-fancy', 'fas fa-pen-alt', 'fas fa-pen', 'fas fa-paste', 'fas fa-minus-square', 'fas fa-minus-circle', 'fas fa-minus', 'fas fa-microphone-slash', 'fas fa-microphone-alt', 'fas fa-microphone', 'fas fa-meh', 'fas fa-medal', 'fas fa-marker', 'fas fa-magic', 'fas fa-language', 'fas fa-info-circle', 'fas fa-info', 'fas fa-i-cursor', 'fas fa-home', 'fas fa-history', 'fas fa-heart', 'fas fa-hashtag', 'fas fa-grip-vertical', 'fas fa-grip-horizontal', 'fas fa-glasses', 'fas fa-frown', 'fas fa-folder-open', 'fas fa-folder', 'fas fa-flag-checkered', 'fas fa-flag', 'fas fa-fingerprint', 'fas fa-filter', 'fas fa-file-upload', 'fas fa-file-import', 'fas fa-file-export', 'fas fa-file-download', 'fas fa-file-alt', 'fas fa-file', 'fas fa-eye-slash', 'fas fa-eye', 'fas fa-external-link-square-alt', 'fas fa-external-link-alt', 'fas fa-exclamation-triangle', 'fas fa-exclamation-circle', 'fas fa-exclamation', 'fas fa-eraser', 'fas fa-envelope-open', 'fas fa-envelope', 'fas fa-ellipsis-v', 'fas fa-ellipsis-h', 'fas fa-edit', 'fas fa-download', 'fas fa-dot-circle', 'fas fa-database', 'fas fa-cut', 'fas fa-copy', 'fas fa-cogs', 'fas fa-cog', 'fas fa-coffee', 'fas fa-cloud-upload-alt', 'fas fa-cloud-download-alt', 'fas fa-cloud', 'fas fa-clone', 'fas fa-clipboard', 'fas fa-circle', 'fas fa-check-square', 'fas fa-check-double', 'fas fa-check-circle', 'fas fa-check', 'fas fa-certificate', 'fas fa-calendar-times', 'fas fa-calendar-plus', 'fas fa-calendar-minus', 'fas fa-calendar-check', 'fas fa-calendar-alt', 'fas fa-calendar', 'fas fa-calculator', 'fas fa-bullseye', 'fas fa-bullhorn', 'fas fa-bug', 'fas fa-bell-slash', 'fas fa-bell', 'fas fa-beer', 'fas fa-bars', 'fas fa-barcode', 'fas fa-ban', 'fas fa-award', 'far fa-user-circle', 'far fa-user', 'far fa-trash-alt', 'far fa-times-circle', 'far fa-thumbs-up', 'far fa-thumbs-down', 'far fa-star-half', 'far fa-star', 'far fa-smile', 'far fa-share-square', 'far fa-save', 'far fa-question-circle', 'far fa-plus-square', 'far fa-minus-square', 'far fa-meh', 'far fa-heart', 'far fa-frown', 'far fa-folder-open', 'far fa-folder', 'far fa-flag', 'far fa-file-alt', 'far fa-file', 'far fa-eye-slash', 'far fa-eye', 'far fa-envelope-open', 'far fa-envelope', 'far fa-edit', 'far fa-dot-circle', 'far fa-copy', 'far fa-clone', 'far fa-clipboard', 'far fa-circle', 'far fa-check-square', 'far fa-check-circle', 'far fa-calendar-times', 'far fa-calendar-plus', 'far fa-calendar-minus', 'far fa-calendar-check', 'far fa-calendar-alt', 'far fa-calendar', 'far fa-bell-slash', 'far fa-bell'],
    'Logistics': ['fas fa-warehouse', 'fas fa-truck', 'fas fa-shipping-fast', 'fas fa-pallet', 'fas fa-dolly-flatbed', 'fas fa-dolly', 'fas fa-clipboard-list', 'fas fa-clipboard-check', 'fas fa-boxes', 'fas fa-box'],
    'Maps': ['fas fa-wrench', 'fas fa-wine-glass', 'fas fa-wifi', 'fas fa-wheelchair', 'fas fa-utensils', 'fas fa-utensil-spoon', 'fas fa-university', 'fas fa-umbrella', 'fas fa-tty', 'fas fa-truck', 'fas fa-trophy', 'fas fa-tree', 'fas fa-train', 'fas fa-traffic-light', 'fas fa-tint', 'fas fa-ticket-alt', 'fas fa-thumbtack', 'fas fa-taxi', 'fas fa-tags', 'fas fa-tag', 'fas fa-suitcase', 'fas fa-subway', 'fas fa-street-view', 'fas fa-shower', 'fas fa-shopping-cart', 'fas fa-shopping-basket', 'fas fa-shopping-bag', 'fas fa-shoe-prints', 'fas fa-ship', 'fas fa-search-plus', 'fas fa-search-minus', 'fas fa-search', 'fas fa-route', 'fas fa-rocket', 'fas fa-road', 'fas fa-recycle', 'fas fa-print', 'fas fa-plus-square', 'fas fa-plus', 'fas fa-plug', 'fas fa-plane', 'fas fa-phone-volume', 'fas fa-phone-square', 'fas fa-phone', 'fas fa-paw', 'fas fa-parking', 'fas fa-newspaper', 'fas fa-music', 'fas fa-motorcycle', 'fas fa-money-bill-alt', 'fas fa-money-bill', 'fas fa-medkit', 'fas fa-map-signs', 'fas fa-map-pin', 'fas fa-map-marker-alt', 'fas fa-map-marker', 'fas fa-map', 'fas fa-male', 'fas fa-magnet', 'fas fa-low-vision', 'fas fa-location-arrow', 'fas fa-lightbulb', 'fas fa-life-ring', 'fas fa-lemon', 'fas fa-leaf', 'fas fa-layer-group', 'fas fa-landmark', 'fas fa-key', 'fas fa-info-circle', 'fas fa-info', 'fas fa-industry', 'fas fa-images', 'fas fa-image', 'fas fa-hospital', 'fas fa-home', 'fas fa-helicopter', 'fas fa-heartbeat', 'fas fa-heart', 'fas fa-h-square', 'fas fa-graduation-cap', 'fas fa-globe', 'fas fa-glass-martini', 'fas fa-gift', 'fas fa-gavel', 'fas fa-gamepad', 'fas fa-flask', 'fas fa-flag-checkered', 'fas fa-flag', 'fas fa-fire-extinguisher', 'fas fa-fire', 'fas fa-fighter-jet', 'fas fa-eye-slash', 'fas fa-eye', 'fas fa-draw-polygon', 'fas fa-dollar-sign', 'fas fa-directions', 'fas fa-crosshairs', 'fas fa-coffee', 'fas fa-car', 'fas fa-building', 'fas fa-briefcase', 'fas fa-bookmark', 'fas fa-book', 'fas fa-bomb', 'fas fa-blind', 'fas fa-birthday-cake', 'fas fa-binoculars', 'fas fa-bicycle', 'fas fa-bell-slash', 'fas fa-bell', 'fas fa-beer', 'fas fa-bed', 'fas fa-bath', 'fas fa-balance-scale', 'fas fa-anchor', 'fas fa-ambulance', 'far fa-plus-square', 'far fa-newspaper', 'far fa-money-bill-alt', 'far fa-map', 'far fa-lightbulb', 'far fa-life-ring', 'far fa-lemon', 'far fa-images', 'far fa-image', 'far fa-hospital', 'far fa-heart', 'far fa-flag', 'far fa-eye-slash', 'far fa-eye', 'far fa-building', 'far fa-bookmark', 'far fa-bell-slash', 'far fa-bell'],
    'Maritime': ['fas fa-wind', 'fas fa-swimmer', 'fas fa-skull-crossbones', 'fas fa-ship', 'fas fa-frog', 'fas fa-dharmachakra', 'fas fa-compass', 'fas fa-binoculars', 'fas fa-anchor', 'far fa-compass'],
    'Marketing': ['fas fa-search-location', 'fas fa-search-dollar', 'fas fa-poll-h', 'fas fa-poll', 'fas fa-mail-bulk', 'fas fa-lightbulb', 'fas fa-funnel-dollar', 'fas fa-envelope-open-text', 'fas fa-comments-dollar', 'fas fa-comment-dollar', 'fas fa-bullseye', 'fas fa-bullhorn', 'fas fa-ad', 'far fa-lightbulb'],
    'Mathematics': ['fas fa-times', 'fas fa-superscript', 'fas fa-subscript', 'fas fa-square-root-alt', 'fas fa-plus', 'fas fa-percentage', 'fas fa-not-equal', 'fas fa-minus', 'fas fa-less-than-equal', 'fas fa-less-than', 'fas fa-infinity', 'fas fa-greater-than-equal', 'fas fa-greater-than', 'fas fa-equals', 'fas fa-divide', 'fas fa-calculator'],
    'Medical': ['fas fa-x-ray', 'fas fa-weight', 'fas fa-vials', 'fas fa-vial', 'fas fa-user-md', 'fas fa-tooth', 'fas fa-thermometer', 'fas fa-teeth-open', 'fas fa-teeth', 'fas fa-tablets', 'fas fa-syringe', 'fas fa-stethoscope', 'fas fa-star-of-life', 'fas fa-smoking-ban', 'fas fa-smoking', 'fas fa-procedures', 'fas fa-prescription-bottle-alt', 'fas fa-prescription-bottle', 'fas fa-prescription', 'fas fa-poop', 'fas fa-plus', 'fas fa-pills', 'fas fa-notes-medical', 'fas fa-mortar-pestle', 'fas fa-microscope', 'fas fa-joint', 'fas fa-id-card-alt', 'fas fa-hospital-symbol', 'fas fa-hospital-alt', 'fas fa-hospital', 'fas fa-heartbeat', 'fas fa-heart', 'fas fa-head-side-mask', 'fas fa-first-aid', 'fas fa-file-prescription', 'fas fa-file-medical-alt', 'fas fa-file-medical', 'fas fa-dna', 'fas fa-diagnoses', 'fas fa-capsules', 'fas fa-cannabis', 'fas fa-burn', 'fas fa-briefcase-medical', 'fas fa-brain', 'fas fa-bong', 'fas fa-bone', 'fas fa-band-aid', 'fas fa-ambulance', 'fas fa-allergies', 'far fa-hospital', 'far fa-heart'],
    'Moving': ['fas fa-wine-glass', 'fas fa-truck-moving', 'fas fa-truck-loading', 'fas fa-tape', 'fas fa-suitcase', 'fas fa-sign', 'fas fa-route', 'fas fa-people-carry', 'fas fa-dolly', 'fas fa-couch', 'fas fa-box-open', 'fas fa-archive'],
    'Music': ['fas fa-volume-up', 'fas fa-volume-off', 'fas fa-volume-mute', 'fas fa-volume-down', 'fas fa-sliders-h', 'fas fa-play', 'fas fa-music', 'fas fa-microphone-slash', 'fas fa-microphone-alt-slash', 'fas fa-microphone-alt', 'fas fa-microphone', 'fas fa-headphones-alt', 'fas fa-headphones', 'fas fa-file-audio', 'fas fa-drum-steelpan', 'fas fa-drum', 'fas fa-compact-disc', 'fab fa-spotify', 'fab fa-soundcloud', 'fab fa-napster', 'far fa-file-audio'],
...
/***/ "./src/icon-picker/font-awesome/css/fontawesome-all.min.css":
/*!******************************************************************!*\
  !*** ./src/icon-picker/font-awesome/css/fontawesome-all.min.css ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
